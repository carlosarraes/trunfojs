    ...
    <section>
      <form className="flex flex-col mt-10 space-y-6">
        <label htmlFor="name" className='flex justify-between gap-3'>
          ...
          <input value={name} type="text" name="name" className="form-input border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-black" />
        </label>
        {/* Stats */}
        <section>
          <label htmlFor="hp" className="flex w-full justify-between gap-3">
            ...
            <input value={hp} type="number" name="hp" id="hp" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
          ...
          <label htmlFor="mana" className="flex w-full justify-between gap-3">
            ...
            <input value={mana} type="number" name="mana" id="mana" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
          ...
          <label htmlFor="attack" className="flex w-full justify-between gap-3">
            ...
            <input value={attack} type="number" name="attack" id="attack" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
          ...
          <label htmlFor="armor" className="flex w-full justify-between gap-3">
            ...
            <input value={armor} type="number" name="armor" id="armor" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
          ...
          <label htmlFor="magic" className="flex w-full justify-between gap-3">
            ...
            <input value={magic} type="number" name="magic" id="magic" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
          ...
          <label htmlFor="speed" className="flex w-full justify-between gap-3">
            ...
            <input value={speed} type="number" name="speed" id="speed" className="form-input w-3/4 border-0 border-b-2 text-center text-sm border-gray-200 focus:ring-0 focus:border-black" />
          </label>
        </section>
        {/* Imagem */}
        <label htmlFor="image" className='relative flex justify-between gap-3'>
          ...
          <input value={image} type="text" name="image" className="form-input border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-black" />
        </label>
        {/* Trunfo e Botao */}
        <section className='flex gap-3 justify-between'>
          <label htmlFor="trunfo" className='flex gap-3'>
            ...
            <input value={trunfo} type="checkbox" name="trunfo" id="trunfo" className='form-checkbox focus:ring-0 self-center' />
          </label>
