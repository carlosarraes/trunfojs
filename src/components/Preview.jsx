  ...
  return (
    <section className='flex flex-col justify-between gap-4 mt-6'>
      ...
      <section className='flex justify-center items-center flex-col gap-4 md:flex-row md:justify-evenly'>
        ...
        <label
          htmlFor='filtroRaridade'
          className='space-x-2 self-center'
        >
          <span>Raridade:</span>
          <select
            name='filtroRaridade'
        ...
        <label
          For='filterTrunfo'
          className='space-x-2 self-center cursor-pointer'
        >
          <input
            type='checkbox'
            id='filterTrunfo'
            className='input-checkbox self-center focus:ring-0 cursor-pointer'
            onChange={handleSent}
          />
