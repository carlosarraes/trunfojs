...
function App() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const { name, hp, mana, attack, armor, speed, rarity, image, query } = data;
    ...
    setData((prevData) => ({
      ...prevData,
      saved: [...query, newEntry],
      query: [...query, newEntry],
    }));
  };
  ...
  const handleFilter = (e) => {
    ...
    const { query } = data;
    const filteredSearch = query.filter((card) =>
